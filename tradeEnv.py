...
class TradeEnv(gym.Env):
    ...
    def _take_action(self, action):
        ...
        self.cur_value_1 = self.cur_value
        ...
        # Hold
            ...
            self.state == 1
            self.cur_value = self.shares_held*current_price
        ...
        # Sell
            ...
            if self.state_1 != 0:
                ...
                self.cur_value = self.sell_value
                self.state = 0
            else:
                self.state = 0
    ...
    def step(self, action, end=True):
        ...
        profit = 0.0
        if self.state_1 != 0 and self.state == 0:
            profit = self.cur_value - self.buy_value

        

        #if self.state_1 != 2 and self.state == 2:
        #    profit = 0.0
        #elif self.state_1 == 2 and self.state == 2:
        #    profit = self.cur_value - self.cur_value_1
        #elif self.state_1 != 0 and self.state == 0:
        #    profit = self.sell_value - self.buy_value
        #elif self.state_1 == 0 and self.state == 0:
        #    profit = 0.0
        #elif self.state_1 != 0 and self.state == 1:
        #    profit = self.cur_value - self.cur_value_1
        #    profit = self.cur_value - self.buy_value
    ...
    def render(self, print_step=False, graph=False, *args):
        ...
        #print(f'Steps            : {round(100*self.total_steps/CONST_SIM_STEPS,2)}% \t {round(self.net_worth, 2)} \t {round(profit_percent, 1)}%')
